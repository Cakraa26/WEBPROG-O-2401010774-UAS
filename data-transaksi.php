...
<head>
  ...
  <title>Data Transaksi - Sepatu Kita</title>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT t_transaksi.*, m_sepatu.nm AS nama_sepatu 
        FROM t_transaksi 
        JOIN m_sepatu ON t_transaksi.produkfk = m_sepatu.id";
                      ...
                      while ($row = mysqli_fetch_array($res)) {
                        ...
                        <tr>
                          ...
                          <td class="text-nowrap">
                            ...
                            <a href="simpan_transaksi.php?hapus=<?= $row["id"] ?>"
          ...
          <?php
          $sepatu = mysqli_query($conn, "SELECT id, nm FROM m_sepatu");
          ?>
                ...
                <form action="simpan_transaksi.php" method="POST">
                  <div class="modal-body">
                    <div class="row">
                      ...
                      <div class="col-12 col-md-6 mb-3 mt-2">
                        <div class="form-floating form-floating-outline">
                          <input type="text" name="nmpelanggan" id="nmpelanggan" class="form-control"
                    ...
                    <div class="row">
                      <div class="col-12 col-md-6 mb-3 mt-2">
                        <div class="form-floating form-floating-outline">
                          <select name="produkfk" id="produkfk" class="form-select" required>
                            <option selected disabled>Pilih Produk</option>
                            <?php while ($p = mysqli_fetch_assoc($sepatu)): ?>
                              <option value="<?= $p['id'] ?>"><?= $p['nm'] ?></option>
                            <?php endwhile; ?>
                          </select>
                          <label for="produkfk">Produk</label>
                        </div>
                      </div>

                      <div class="col-12 col-md-6 mb-3 mt-2">
                        <div class="form-floating form-floating-outline">
                          <input type="number" name="jml" id="jml" class="form-control" placeholder="Masukkan Jumlah" />
                  ...
                  <form action="simpan_transaksi.php" method="POST">
                    <div class="modal-body">
                      ...
                      <div class="row">
                        <div class="col-12 col-md-6 mb-3 mt-2">
                          <div class="form-floating form-floating-outline">
                            <input type="date" name="tgl" id="tgl" class="form-control" value="<?= $row['tgl'] ?>" />
                            <label for="tgl">Tanggal</label>
                          </div>
                        </div>
                        <div class="col-12 col-md-6 mb-3 mt-2">
                          <div class="form-floating form-floating-outline">
                            <input type="text" name="nmpelanggan" id="nmpelanggan" class="form-control"
                              placeholder="Masukkan Nama Pelanggan" value="<?= $row['nmpelanggan'] ?>" />
                            <label for="nmpelanggan">Nama Pelanggan</label>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-12 col-md-6 mb-3 mt-2">
                          <div class="form-floating form-floating-outline">
                            <select name="produkfk" id="produkfk" class="form-select" required>
                              <option selected disabled>Pilih Produk</option>
                              <?php while ($p = mysqli_fetch_assoc($sepatu)): ?>
                                <option value="<?= $p['id'] ?>" <?= ($p['id'] == $row['produkfk']) ? 'selected' : '' ?>>
                                  <?= $p['nm'] ?>
                                </option>
                              <?php endwhile; ?>
                            </select>
                      ...
                      <div class="row">
                        <div class="col-12 col-md-6 mb-3 mt-2">
                          <div class="form-floating form-floating-outline">
                            <input type="number" name="total_harga" id="total_harga" class="form-control"
                              placeholder="Masukkan Total Harga" value="<?= $row['total_harga'] ?>" />
                            <label for="total_harga">Total Harga</label>
                          </div>
                        </div>
