...
<head>
  ...
  <title>Demo: Fluid - Layouts | Materio - Bootstrap Dashboard FREE</title>
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item active">
            <a href="data-sepatu.html" class="menu-link">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-fluid flex-grow-1 container-p-y">
            <div class="card">
              <h5 class="card-header">Data Sepatu</h5>
              <div class="card-body">
                        ...
                        <tr>
                          ...
                          <td class="text-nowrap">
                            ...
                            <a href="simpan_pesanan.php?hapus=<?= $row["id"] ?>"
                              onclick="return confirm('Yakin ingin menghapus pesanan ini?');" class="btn btn-danger"><i
                                class="ri ri-delete-bin-line"></i>
                            </a>
                          </td>
                        </tr>
                        <?php
